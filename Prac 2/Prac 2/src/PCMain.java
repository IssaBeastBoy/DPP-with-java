...
public final class PCMain
  {
    ...
    public PCMain ()
      { // Create channel object
        ...
        CSProcess[] procList = { new Buffer(Item_channel1.in(), Item_channel2.in(), Pro_channel1.in(), Pro_channel2.in(), Con_channel1.out(), Con_channel2.out()), new Producer(Pro_channel2.out(), 1), new Producer(Pro_channel1.out(), 101), new Consumer(Con_channel1.in(), Item_channel1.out(), 1), new Consumer(Con_channel2.in(), Item_channel2.out(), 2) }; // Processes
